...
namespace NDHSITE.Models
{
    ...
    public class ImageUpload
    {
        ...
        public ImageResult RenameUploadFile(byte[] image, string extension, Int32 counter = 0)
        {
            var fileName = user + "_" + DateTime.Now.ToString("ddMMyyyyhhmmss") + extension;
                ...
                (HttpContext.Current.Request.MapPath(UploadPath + "/" + finalFileName)))
            {
                ...
                return RenameUploadFile(image, extension, ++counter);
            }
